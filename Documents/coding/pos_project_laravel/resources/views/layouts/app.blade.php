  ...
  <script>
    ...
    if (chartLineEl) {
     ...
     <div id="sales-data"
       ...
       data-series='@json($salesChart["data"] ?? [])'></div>


      new Chart(ctx1, {
        type: "line",
        data: {
          labels: labels.length ? labels : ["Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
          datasets: [{
            label: "Sales",
            tension: 0.4,
            borderWidth: 0,
            ...
            borderWidth: 3,
            fill: true,
            data: series.length ? series : [50, 40, 300, 220, 500, 250, 400, 230, 500],
            maxBarThickness: 6,
          }],
        },
        options: {
